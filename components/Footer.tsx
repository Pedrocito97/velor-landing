...
export function Footer() {
  return (
    <footer className="relative bg-mocha overflow-hidden">
      ...
      <div className="relative py-28 md:py-36">
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              <Sigil size={50} color="#C5A572" animated={false} />
            </motion.div>

            {/* Brand name */}
            <motion.div className="mt-10" variants={fadeInUp}>
              <p className="text-velor-gold/60 tracking-[0.5em] text-[10px] mb-3 uppercase">
                The House of
              </p>
              <h3 className="font-display text-3xl md:text-4xl tracking-[0.3em] text-ivory">
                VELOR
              </h3>
            </motion.div>
            ...
            {/* Tagline */}
            <motion.p
              className="mt-5 text-ivory/50 tracking-[0.2em] text-xs italic"
              variants={fadeInUp}
            >
            ...
            <motion.div
              ...
              variants={fadeInUp}
            >
              <div className="w-16 h-px bg-gradient-to-r from-transparent to-velor-gold/20" />
              <div className="w-2 h-2 rotate-45 border border-velor-gold/30" />
              <div className="w-16 h-px bg-gradient-to-l from-transparent to-velor-gold/20" />
            </motion.div>
            ...
            >
              {footerLinks.map((link) => (
                <Link
                  key={link.name}
                  href={link.href}
                  className="text-ivory/50 hover:text-velor-gold tracking-[0.2em] text-[11px] uppercase transition-colors duration-300"
                >
                  {link.name}
                </Link>
              ))}
            ...
            {/* Contact */}
            <motion.div className="mt-14 space-y-3" variants={fadeInUp}>
              <p className="text-ivory/30 tracking-[0.3em] text-[10px] uppercase">
                Inquiries
              </p>
              <a
                href="mailto:contact@houseofvelor.com"
                className="text-ivory/60 tracking-[0.15em] text-sm hover:text-velor-gold transition-colors duration-300"
              >
            ...
            >
              {socialLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="text-ivory/40 hover:text-velor-gold transition-all duration-300 hover:scale-110"
            ...
            {/* Ethical badge */}
            <motion.div
              className="mt-14 inline-flex items-center gap-3 px-6 py-3 border border-velor-gold/15"
              variants={fadeInUp}
            >
              <div className="w-1.5 h-1.5 bg-velor-gold/50 rounded-full" />
              <span className="text-ivory/40 tracking-[0.2em] text-[9px] uppercase">
        ...
        {/* Corner accents */}
        <div className="absolute top-16 left-16 w-20 h-20 hidden lg:block">
        ...
        <div className="absolute top-16 right-16 w-20 h-20 hidden lg:block">
        ...
        <div className="absolute bottom-28 left-16 w-20 h-20 hidden lg:block">
        ...
        <div className="absolute bottom-28 right-16 w-20 h-20 hidden lg:block">
      ...
      {/* Bottom bar */}
      <div className="border-t border-velor-gold/10">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] text-ivory/30 tracking-[0.15em]">
            <p>
            ...
            <div className="flex items-center gap-8">
              <a
                href="#"
                className="hover:text-velor-gold transition-colors duration-300 uppercase"
              >
                Privacy
              </a>
